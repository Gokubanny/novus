        ...
        <>
          ...
          <Alert variant="destructive">
            ...
            <AlertDescription>
              ...
              You can re-edit your address submission and then confirm your location during your verification window.
            </AlertDescription>
          </Alert>

          {/* Option to re-edit address */}
          <Card>
            <CardHeader>
              <CardTitle>Update Your Address</CardTitle>
              <CardDescription>
                Review and update your address information, then re-verify your location
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="p-4 bg-muted rounded-lg">
                <p className="text-sm text-muted-foreground mb-2">Current Submitted Address:</p>
                <p className="font-medium">
                  {verification.address_details?.full_address || verification.street}
                  {(verification.address_details?.city || verification.city) && `, ${verification.address_details?.city || verification.city}`}
                  {(verification.address_details?.state || verification.state) && `, ${verification.address_details?.state || verification.state}`}
